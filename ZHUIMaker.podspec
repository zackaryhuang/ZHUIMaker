...
Pod::Spec.new do |s|
  s.name             = 'ZHUIMaker'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZHUIMaker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Zackary Huang/ZHUIMaker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Zackary Huang' => 'huangchao0623@126.com' }
  s.source           = { :git => 'https://github.com/Zackary Huang/ZHUIMaker.git', :tag => s.version.to_s }
